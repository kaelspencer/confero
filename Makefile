...
# Generated by qmake (2.01a) (Qt 4.7.2) on: Sat May 21 17:41:19 2011
# Project:  Confero.pro
# Template: app
...
bin/obj/Encryption.o: src/Encryption.cpp src/Encryption.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o bin/obj/Encryption.o src/Encryption.cpp
